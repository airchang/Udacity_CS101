...
def involved(courses, person):
    ...
    for hexamester in courses:
        for subj in courses[hexamester]:
            for pos in courses[hexamester][subj]:
                if courses[hexamester][subj][pos] ==person:
                    if hexamester in result:
                        result[hexamester].append(subj)
                    else:
                        result[hexamester] = [subj]
    return result
